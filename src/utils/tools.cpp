...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_CONTAINERNOTENOUGHROOM:
			return "Você não pode colocar mais objetos neste recipiente.";
                ...
                case RETURNVALUE_ONLYAMMOINQUIVER:
                        return "Você só pode colocar bolts e arrows.\nVocê não pode colocar nenhum outro item.";
		...
		case RETURNVALUE_CREATUREDOESNOTEXIST:
			return "Esta criatura não existe.";
		...
		case RETURNVALUE_PLAYERWITHTHISNAMEISNOTONLINE:
			return "O jogador com este nome não está online.";
		...
		case RETURNVALUE_YOUMAYNOTATTACKAPERSONINPROTECTIONZONE:
			return "Você não pode atacar um jogador em uma zona de proteção.";

		case RETURNVALUE_YOUMAYNOTATTACKAPERSONWHILEINPROTECTIONZONE:
			return "Você não pode atacar um jogador enquanto estiver em uma zona de proteção.";

		case RETURNVALUE_YOUCANONLYUSEITONCREATURES:
			return "Você só pode usar isto em criaturas";

		case RETURNVALUE_TURNSECUREMODETOATTACKUNMARKEDPLAYERS:
			return "Ative a mão de PvP se você quiser atacar jogadores que não estejam com nenhuma caveira.";
		...
		case RETURNVALUE_ACTIONNOTPERMITTEDINANOPVPZONE:
			return "Esta ação não é permitida em uma zona protegida de No-PvP.";

		case RETURNVALUE_YOUCANNOTLOGOUTHERE:
			return "Você não pode desconectar aqui.";

		case RETURNVALUE_YOUNEEDAMAGICITEMTOCASTSPELL:
			return "Você precisa de uma blank rune para conjurar esta magia.";
		...
		case RETURNVALUE_TRADEPLAYERALREADYOWNSAHOUSE:
			return "O jogador que você quer negociar esta casa já é dono de uma.";
		...
		case RETURNVALUE_YOUCANNOTTRADETHISHOUSE:
			return "Você não pode vender esta casa.";

		case RETURNVALUE_YOUDONTHAVEREQUIREDPROFESSION:
			return "Você não tem a vocação necessária.";
		...
		case RETURNVALUE_NOTENOUGHSHIELDLEVEL:
			return "Você não tem nível de shield suficiente";
